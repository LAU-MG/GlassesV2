...
function Featured() {
  return (
    <PageLayout title='Featured Products' heroImage='/images/hero-section.png' heroImageWidth={600} heroImageHeight={400}>
      <div className='container'>
        <div className='row align-items-center'>
          <div className='col-md-6'>{/* Espace laissé vide pour l'alignement */}</div>
        </div>
      </div>
        ...
        <div className='row'>
          {[
            ...
            <div className='col-md-3 mb-4' key={index}>
              <ProductCard title={product.title} description='Description' image={product.image} width={190} height={200} />
            </div>
          ))}
        </div>
      </div>
